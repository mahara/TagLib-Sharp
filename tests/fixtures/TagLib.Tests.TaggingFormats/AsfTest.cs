	...
	public class AsfTest
	{
		...
		public void TestPictures ()
		{
			...
			Picture [] pictures = new Picture [] {
				new Picture (TestHelper.ExamplesPath + "covers/sample_a.png"),
				new Picture (TestHelper.ExamplesPath + "covers/sample_a.jpg"),
				new Picture (TestHelper.ExamplesPath + "covers/sample_b.png"),
				new Picture (TestHelper.ExamplesPath + "covers/sample_b.jpg"),
				new Picture (TestHelper.ExamplesPath + "covers/sample_c.png"),
				new Picture (TestHelper.ExamplesPath + "covers/sample_c.jpg")
			};
		...
		public void TestClear ()
		{
            ...
            file.Tag.Pictures = new Picture[] { new Picture(TestHelper.ExamplesPath + "covers/sample_a.png") };
