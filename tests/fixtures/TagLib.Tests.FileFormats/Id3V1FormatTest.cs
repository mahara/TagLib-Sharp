...
{   
    ...
    {
        private static string sample_file = TestHelper.SamplesPath + "samples/sample_v1_only.mp3";
        private static string tmp_file = TestHelper.SamplesPath + "samples/tmpwrite_v1_only.mp3";
        private File file;
