...
namespace TagLib.Tests.Images
{
    ...
    {
        private static string sample_file = TestHelper.SamplesPath + "samples/sample.jpg";
        private static string tmp_file = TestHelper.SamplesPath + "samples/tmpwrite_exceed_segment_size.jpg";
