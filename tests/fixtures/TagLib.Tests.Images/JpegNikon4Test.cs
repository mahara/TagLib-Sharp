...
namespace TagLib.Tests.Images
{
	...
	{
        private static string sample_file = TestHelper.SamplesPath + "samples/sample_nikon4.jpg";
        private static string tmp_file = TestHelper.SamplesPath + "samples/tmpwrite_nikon4.jpg";
