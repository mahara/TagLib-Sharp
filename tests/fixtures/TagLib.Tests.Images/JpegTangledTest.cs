...
namespace TagLib.Tests.Images
{
	...
	public class JpegTangledTest
	{
        ...
        private static string sample_file = TestHelper.SamplesPath + "samples/sample_tangled{0}.jpg";
        private static string tmp_file = TestHelper.SamplesPath + "samples/tmpwrite_tangled{0}.jpg";
