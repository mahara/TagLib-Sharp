...
namespace TagLib.Tests.Images
{
	...
	{
        private static string sample_file = TestHelper.SamplesPath + "samples/sample_nikon3.jpg";
        private static string tmp_file = TestHelper.SamplesPath + "samples/tmpwrite_nikon3.jpg";
